...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground bg-gradient-to-br dark:from-slate-900 dark:via-blue-900 dark:to-slate-900 light:from-blue-50 light:via-white light:to-blue-50 relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative border-b-indigo-500 z-10 p-6">
        <nav className="flex items-center justify-between border-b-indigo-500  max-w-7xl mx-auto">
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center space-x-2 bg-blue-500/90 border border-blue-500/20 rounded-full px-4 py-2 mb-8">
            <Rocket className="h-4 w-4 text-white" />
            <span className="text-white text-sm font-khand font-medium">AI Budget Forecaster</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-array font-bold text-foreground mb-6">
            Fast, Accurate
            <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent"> AI Budget </span>
            Forecasts
          </h1>
          
          <p className="text-xl font-khand text-muted-foreground mb-12 max-w-2xl mx-auto">
            ...
            <Button
              asChild
              size="lg" 
              className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 text-white dark:text-white px-8 py-4 text-lg font-khand font-semibold transition-all transform hover:scale-105 focus:scale-105"
            >
              <Link href="/auth" className="flex items-center space-x-2 no-underline">
      ...
      <section id="features" className="relative z-10 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-array font-bold text-foreground mb-6">
              Everything You Need for 
              <span className="bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent"> AI Cost Planning</span>
            </h2>
            <p className="text-xl font-khand text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Quick Estimate */}
            <div className="bg-card border border-border p-8 rounded-2xl hover:border-blue-400/40 transition-all">
              <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-6">
                <Zap className="h-6 w-6 text-blue-400" />
              </div>
              <h3 className="text-xl font-array font-semibold text-card-foreground mb-4">Quick Estimate</h3>
            ...
            {/* Budget Editor */}
            <div className="bg-card border border-border p-8 rounded-2xl hover:border-purple-400/40 transition-all">
            ...
            {/* Scenario Planning */}
            <div className="bg-card border border-border p-8 rounded-2xl hover:border-cyan-400/40 transition-all">
      ...
      <section id="pricing" className="relative z-10 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Starter Plan */}
            <div className="bg-card border border-border p-8 rounded-2xl hover:border-blue-500/50 transition-all">
              <div className="text-center">
                <h3 className="text-xl font-array font-semibold text-card-foreground mb-2">Starter</h3>
                <div className="mb-6">
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-card border border-border p-12 rounded-3xl">
            <h2 className="text-4xl font-array font-bold text-card-foreground mb-6">
              Ready to Optimize Your AI Budget?
            </h2>
            <p className="text-xl font-khand text-muted-foreground mb-8">
              Join thousands of teams using CostPilot to make smarter AI investment decisions.
            </p>
            <Button asChild size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 font-khand">
      ...
      <footer className="relative z-10 px-6 py-12 border-t border-border">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-2 mb-6">
            ...
            <span className="text-xl font-array font-bold text-foreground">CostPilot</span>
          </div>
          <p className="font-khand text-muted-foreground mb-6">
            AI Budget Forecaster - Fast, accurate budget forecasts for AI projects.
          </p>
          <div className="flex justify-center space-x-6 text-sm font-khand text-muted-foreground">
