    ...
    <>
      ...
      `}>
        ...
        <div className={`flex items-center p-4 ${
          isCollapsed && !isMobile ? 'flex-col space-y-3' : 'justify-between'
        } mb-6 md:mb-8 border-b border-gray-200 dark:border-slate-700`}>
          <div className={`flex items-center ${
            isCollapsed && !isMobile ? 'flex-col space-y-2' : 'space-x-2'
          }`}>
            <Calculator className={`${
              isCollapsed && !isMobile ? 'h-6 w-6' : 'h-6 w-6'
        ...
        <nav className="space-y-2 mb-6 md:mb-8 px-4">
          <button
            ...
            className={`w-full flex items-center ${
              isCollapsed && !isMobile ? 'justify-center py-3' : 'space-x-3'
        ...
        <div className="absolute bottom-4 left-4 right-4 space-y-2">
          ...
          } px-3 py-2 border-t border-gray-200 dark:border-slate-700 pt-4`}>
            {(!isCollapsed || isMobile) ? (
              <>
                ...
                <button
                  ...
                  className="p-1 rounded-md hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors flex-shrink-0"
                  title="Sign out"
                >
      ...
      {/* Create Project Dialog - Updated to use EnterpriseProjectForm */}
          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="relative inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
              <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8 px-4">
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-4 md:p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold py-2 md:py-3 px-4 rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-200 md:transform md:hover:scale-105 text-sm"
                    >
                      Contact Sales
                    </button>
                    <p className="text-xs text-center text-gray-500 dark:text-gray-400 mt-2">
                ...
                <div className="text-center border-t border-gray-200 dark:border-gray-700 pt-6 px-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:justify-center">
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors w-full sm:w-auto justify-center"
                >
                  Maybe Later
                </button>
              </div>
